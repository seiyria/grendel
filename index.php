	...
	<body>
        ...
        <div class="container">
			...
			<div class="row-fluid" style="text-align: justify;">
				...
				<div class="span4">
					<h2>Contact</h2>
					<p>After reviewing the website and making notes for improvement, go forth and contact the business! Bolster your local reputation or develop internationally!</p>
				</div>
			</div>
